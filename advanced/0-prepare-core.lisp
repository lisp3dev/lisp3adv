...
(DEFPACKAGE :LISP3DEV.ADVANCED.CORE
  ...
  (:USE :CL :LISP3DEV.BASE :LISP3DEV.ALGEBRAIC.CORE :LISP3DEV.ALGEBRAIC.XDATA :LISP3DEV.PROLOG)
  ;(:SHADOW CL:DEFUN)
  )

(DEFVAR LISP3DEV.ADVANCED.CORE:*QI-READTABLE* *READTABLE*)
